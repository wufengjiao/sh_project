...
//            $tools->append("<a href='/admin/apply/create' class='btn btn-sm btn-success' style='float: right;'>
...
//</a>");
    ...
    public function create(Content $content){
        ...
        return view('apply.apply')
            ->with(['number'=>$rand_number,'projects'=>$projects,'category'=>$category]);
    }
    ...
    public function store(Request $Request){
        $this->validate($Request,[
            'number'=>'required',//采购编号
            'project'=>'required',//采购项目
        ]);
        $data = $Request->all();
        return redirect()->route('apply/index')->with(['success'=>1,'message'=>'']);
    }
}
